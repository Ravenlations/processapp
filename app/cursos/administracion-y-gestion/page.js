...
async function getCourses() {
    const res = await fetch ('https://process-control.pockethost.io' + '/api/collections/Cursos/records' + '?page=1&perPage=6&filter=(TipoCurso="Administracion")', 
    {cache: 'no-store'}
    );
...
<>
        ...
        <div id="PageTitle" className="FlexboxColumn"> <span> Administracion y Gestion </span> </div>  
