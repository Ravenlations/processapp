...
async function getCourses() {
    const res = await fetch ('https://process-control.pockethost.io' + '/api/collections/Cursos/records' + '?page=1&perPage=6&filter=(TipoCurso="Servicios%20Socioculturales")', 
    {cache: 'no-store'}
    );
...
<>
        ...
        <div id="PageTitle" className="FlexboxColumn"> <span> Servicios Socioculturales </span> </div>  
